...
const adoptionForms = Array.from(
	document.getElementsByClassName('cat-adoption')
);
...
const applicationForms = Array.from(
	document.getElementsByClassName('application-link')
);
...
const acceptedAdoptions = Array.from(
	document.getElementsByClassName('accepted')
);
const applicantDisplays = [
	{
		element: document.getElementById('applicant-first-name'),
		key: 'first_name',
		foretext: 'First Name: ',
	},
	{
		element: document.getElementById('applicant-last-name'),
		key: 'last_name',
		foretext: 'Last Name: ',
	},
	{
		element: document.getElementById('applicant-address'),
		key: 'address',
		foretext: 'Address: ',
	},
	{
		element: document.getElementById('applicant-reason'),
		key: 'reason',
		foretext: '',
	},
	{
		element: document.getElementById('applicant-age'),
		key: 'age',
		foretext: 'Age: ',
	},
];
